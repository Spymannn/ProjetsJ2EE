...
public class inscriptionMembre extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String suite="/index.jsp?page=inscriptionValide.jsp";
        ArrayList<String> erreurs=new ArrayList<String>();
        HttpSession session=request.getSession(true);
        try {
            ClientDB cl = new ClientDB(nom, prenom, adresse, cp, loc, mail, mdp);
            cl.create();
            session.setAttribute("newCl", cl);
        } catch (Exception e) {
            suite = "/index.jsp?page=inscription.jsp";
