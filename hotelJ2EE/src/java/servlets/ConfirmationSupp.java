 ...
 * @author Spymannn
 */
public class ConfirmationSupp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String confirm = request.getParameter("confirmerSupp");
        ...
        try {
            if(confirm.equals("Je confirme")){
                ReservationDB res = (ReservationDB)session.getAttribute("reservSupp");
                res.delete();
            }
            if(confirm.equals("J'annule")){
                erreurs.add("Annulation de suppression !");
                suite="/index.jsp?page=mesReservations.jsp";
            }
