...
public class Reservation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String suite="/index.jsp?page=mesReservations.jsp";
        ArrayList<String> erreurs=new ArrayList<String>();
        HttpSession session=request.getSession(true);
        //if (reserv.equals("reservation")) {//regarde si on a appuyé sur le bouton mes reservations
            
            ClientDB clr = new ClientDB();
            clr =(ClientDB)session.getAttribute("client");
            try {
                clr.read();
               ...
               // erreurs.add(e.getMessage());//Si on ne trouve pas le client,ici on va noté client introuvable
                //suite = "/index.jsp?page=mesReservation.jsp";;  //et on revient alors ensuite sur la page d'accueil
                session.setAttribute("tabReserv",null);
            }
        //}
